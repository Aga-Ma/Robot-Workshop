...
(function( root, factory ) {
	...
	var SLIDES_SELECTOR = '.slides section',
		...
		config = {
			...
			parallaxBackgroundImage: 'images/download.jpg', // CSS syntax, e.g. "a.jpg"

			// Parallax background size
			parallaxBackgroundSize: '14312px 3021px', // CSS syntax, e.g. "3000px 2000px"

			// Amount of pixels to move the parallax background per slide step
			parallaxBackgroundHorizontal: 960,
